...
bash tests/scripts/add_multiple_proofs.sh true "tests/inputs/production.json"
...
# bash tests/scripts/add_multiple_proofs.sh false "tests/inputs/production.json" false false false
